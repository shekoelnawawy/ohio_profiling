...
patient = patients[0]
df_0 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
patient = patients[1]
df_1 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
patient = patients[2]
df_2 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
patient = patients[3]
df_3 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
patient = patients[4]
df_4 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
patient = patients[5]
df_5 = joblib.load('/Data/Patients/' + year + '/' + patient + '/instantaneous_error.pkl')
